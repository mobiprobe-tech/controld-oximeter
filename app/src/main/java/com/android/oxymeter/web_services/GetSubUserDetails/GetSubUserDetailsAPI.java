package com.android.oxymeter.web_services.GetSubUserDetails;
...
public class GetSubUserDetailsAPI {

    private Call<UserDetailsResponse> call;

    public GetSubUserDetailsAPI(FragmentActivity activity, boolean showProgress, String userID, UserDetailsCallback callback) {
                    ...
                    try {
                        ...
                        if ((response.body() != null ? response.body().getResponseCode() : 0) == 1) {
                            ...
                            if (response.body().getData() != null) {
                                ...
                                userDetailsResponse.setName(CommonUtils.checkData(response.body().getData().get(0).getName()));
