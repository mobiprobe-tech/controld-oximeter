package com.android.oxymeter.web_services.AddSubUser;
...
public class AddSubUserAPI {

    private Call<GenericResponse> call;

    public AddSubUserAPI(FragmentActivity activity, boolean showProgress, String name, String email, String mobile, String gender, String dob, String height, String weight, String bloodGroup, GenericCallback callback) {

        if (showProgress) {
            CommonUtils.showProgress(activity, activity.getResources().getString(R.string.progress_msg_save));
        }
        ...
        call = service.addSubUser(userToken, name, email, mobile, gender, dob, height, weight, bloodGroup);
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if ((response.body() != null ? response.body().getResponseCode() : 0) == 1) {
                            ...
                            String successMessage = activity.getResources().getString(R.string.user_add_success);
