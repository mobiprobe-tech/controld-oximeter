...
public class WaveformView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public WaveformView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int waveColor = arr.getColor(R.styleable.WaveformView_waveColor, getResources().getColor(R.color.waveform_lineColor));
        mLineWidth = arr.getDimension(R.styleable.WaveformView_lineWidth, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, metrics));//2
        pointStep = arr.getDimension(R.styleable.WaveformView_pointStep, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1.4f, metrics));//1.4
