...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        else if (SampleGattAttributes.UUID_CHARACTER_RECEIVE_OXYGEN.equals(characteristic.getUuid())) {
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
       ...
       /* if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
        ...
        // This is specific to Oximeter Data Transfer.
         if (SampleGattAttributes.UUID_CHARACTER_RECEIVE_OXYGEN.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG_OXYGEN));
